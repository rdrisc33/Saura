...
class MyKicadFootprintConverter():
    def __init__(self, kicad_mod_file ): # Kicad footprint files have extension '.kicad_mod'        
        # print()
        # print('FILE:', kicad_mod_file)
        with open(kicad_mod_file) as fo: 
        ...
        self.kicad_mod_file = kicad_mod_file
        
    @classmethod
    def convert(cls, kicad_mod_file):
        c = cls(kicad_mod_file)
...
#   )
    ...
    def save(self, verbose = False): # Perhaps 'setup_folders'
        _, tail = os.path.split(self.kicad_mod_file)
...
save_file = MyKicadFootprintConverter.convert(os.path.join(kicad_third_party_footprints_path , 'GRM21BR61E106KA73L', 'G-21_MUR.kicad_mod'))
