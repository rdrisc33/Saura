...
seeker_radius = 2 # Radius about pointer, self.self.terminals within which will becoonme snap location for our line( NOT our cursor -- we don't want to steal control of mouse from user. But its good to steal control of our line item from the cursor)
